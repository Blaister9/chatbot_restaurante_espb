class OpenAiClass {
    openAiOptions = { model: '', temperature: 0, apiKey: '', max_tokens: 150 }

    constructor(_options = { model: 'gpt-3.5-turbo-0301', temperature: 0, apiKey: '', max_tokens: 150 }) {
        if (!_options?.apiKey) {
    ...
    sendChat = async (messages = []) => {
        ...
        const raw = JSON.stringify({
            ...
            messages,
            max_tokens: this.openAiOptions.max_tokens
        })
